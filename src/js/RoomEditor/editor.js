...
function preload() {
	...
	keyImage = loadImage('assets/room/items/key.png');
	brickImage = loadImage('assets/rooms/tiles/WallRoughDraft.png');
	flashlightImage = loadImage('assets/rooms/items/Flashlight.png');
	floorBoardImage = loadImage("assets/rooms/tiles/floortiles.png");
	doorImage=loadImage("assets/rooms/tiles/Door.png");
    cellBarsImage = loadImage("assets/rooms/tiles/cellBars.jpg");
